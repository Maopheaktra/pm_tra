<template>
  <div class="container mt-4">
    ...
    <employee-table v-for="employee in employees" :key="employee.id" :employee="employee"></employee-table>
    <employee-card>
      <button class="btn btn-info btn-sm" @click="infoDetail">Details</button>
    </employee-card>
  </div>
</template>
